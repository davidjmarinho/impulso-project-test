...
{
    public abstract class ImpulsoProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ImpulsoProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ImpulsoProjectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ImpulsoProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ImpulsoProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ImpulsoProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ImpulsoProjectDbContext, Task<T>> func)
        {
            T result;
